...
@export var resource_costs: Dictionary = {} # {"food": 5, "money": 10.0}
@export var base_effects: Dictionary = {} # Squad stat modifications
@export var location_requirements: Array = [] # Array of LocationType enums
