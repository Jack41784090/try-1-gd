...
- **Inventory & Equipment System** (`src/strategy/core/inventory.gd`, `src/strategy/core/loot_collector.gd`):
  ...
  - Combat victory overlay shows looted equipment (weapon names in blue, armor names in gold) via `_spawn_equipment_loot_display()`
